    ...
    <div class="product_left clear">
        ...
        <div class="proInfo_area">
            ...
            <div class="buy_action">
            	<a href="#" class="buy_btn" onclick="createOrder(${good.id!""},3);">创建采购订单</a>
        			...
        			<#list good.relativeGoods as relativeGood>
        				<li>
		                	<div class="hotPro_img">
		                		<a href="<@spring.url "/good/agent/${relativeGood.id}/detail" />">
...
<script type="text/javascript">	
	...
	function goodCommentPageChange(page) {
		var id=$("#good_id").val()
	    $.post('<@spring.url "/good/agent/comment/"+id+"/page" />',
	            {"page": page
	            },
	            function (data) {
