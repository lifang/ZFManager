	 	...
	 	<#list order.orderGoods as orderGood>
		  <tr>
		        ...
		        <div class="td_proBox">
		            ...
		            <div class="td_proBox_info">
		                ...
		                <ul>
		                    ...
		                    <li><span>支付通道：</span>
		                    	<div class="c_text">
		                    		<#if orderGood.payChannel??>${orderGood.payChannel.name!""}</#if>
		                    		<input id="payChannelId" type="hidden" name="payChannelId" value="<#if orderGood.payChannel??>${orderGood.payChannel.id!""}</#if>" />
		                    	</div>
		    ...
		    <#if orderGood.good?? && orderGood.payChannel??>
			    <td><a href="#"><strong>￥${(((orderGood.good.purchasePrice!0)+(orderGood.payChannel.openingCost!0))/100)?string("0.0")}</strong></a></td>
			    <td>
			    ...
			    <td><a href="#"><strong id="goodPriceStrong_${orderGood.good.id}">￥${(((orderGood.good.purchasePrice!0)+(orderGood.payChannel.openingCost!0))*orderGood.quantity/100)?string("0.00")}</strong></a></td>
			</#if>
		  </tr>
		 </#list>
	  </#if>
	...
	<table width="100%" cellspacing="0" cellpadding="0" class="b_table">
	 ...
	 <thead>
	  ...
	  <tr>
	    ...
	    <#if payChannel??>
		    <td><a href="#"><strong>￥${(((good.purchasePrice!0)+(payChannel.openingCost!0))/100)?string("0.0")}</strong></a></td>
		    <td>
		    	<div class="choose_amount">
		    		<a href="javascript:void(0);" onclick="reduceQuantity(${good.id},${((good.purchasePrice!0)+(payChannel.openingCost!0))});">-</a>
		    		...
		    		<a href="javascript:void(0);"  onclick="addQuantity(${good.id},${((good.purchasePrice!0)+(payChannel.openingCost!0))});">+</a>
		    	</div>
		    </td>
		    <td><a href="#"><strong id="goodPriceStrong_${good.id}">￥${(((good.purchasePrice!0)+(payChannel.openingCost!0))*quantity/100)?string("0.00")}</strong></a></td>
	    </#if>
	  </tr>
	</table>
</#if>	
