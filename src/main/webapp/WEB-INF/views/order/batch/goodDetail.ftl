    ...
    <div class="product_left clear">
        ...
        <div class="proInfo_area">
            ...
            <div class="pac_summary">
            	<ul>
            		<li class="price_li"><span>零售价</span><div class="text"><strong class="original">￥<#if payChannel??>${(((good.retailPrice!0)+(payChannel.openingCost!0))/100)?string("0.00")}</#if></strong></div></li>
                	<li class="price_li"><span>批购价</span><div class="text"><strong>￥<#if payChannel??>${(((good.purchasePrice!0)+(payChannel.openingCost!0))/100)?string("0.00")}</#if></strong></div></li>
        			...
        			<#list good.relativeGoods as relativeGood>
        				<li>
		                	<div class="hotPro_img">
		                		<a href="<@spring.url "/good/batch/${relativeGood.id}/detail" />">
