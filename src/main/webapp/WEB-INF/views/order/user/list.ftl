    ...
    <div class="uesr_table">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="b_table">
            ...
            <tr>
                ...
                <td><a href="#" class="a_btn">查看详情</a><a href="#" class="a_btn">取消</a>
            ...
            <tr>
                ...
                <td>2</td>
                <td><strong>￥918.00</strong></td>
                <td><strong class="strong_status">已评价</strong></td>
                <td><a href="#" class="a_btn">查看详情</a><a href="#" class="a_btn">备注</a></td>
            </tr>
            </tbody>
            ...
            <tr>
                ...
                <td>2</td>
                <td><strong>￥918.00</strong></td>
                <td><strong class="strong_status">已取消</strong></td>
                <td><a href="#" class="a_btn">查看详情</a><a href="#" class="a_btn">备注</a></td>
            </tr>
            </tbody>
            ...
            <tr>
                ...
                <td>2</td>
                <td><strong>￥918.00</strong></td>
                <td><strong class="strong_status">交易关闭</strong></td>
                <td><a href="#" class="a_btn">查看详情</a><a href="#" class="a_btn">备注</a></td>
            </tr>
            </tbody>
