...
<div class="content clear">
                            ...
                            <#if encryptCardWays??>
                                <#list encryptCardWays as encryptCardWay>
                                    <option value="${encryptCardWay.id}"
                                        ...
                                        ||(!((good.encryptCardWayId)??) && encryptCardWay_index=0) >
                                            selected="true"</#if>
                    ...
                    <div class="text">
                        <#if cardTypes??>
                            <#list cardTypes as cardType>
                                <span class="checkboxRadio_span"><input name="g_cardType" type="checkbox"
                                                                        value="${cardType.id}"
                                    <#if (good.cardTypes)??>
            ...
            <ul>
                ...
                <li><span class="labelSpan">最小批购量：</span>
                    ...
                    <div class="text"><input name="g_floorPurchaseQuantity" type="text"
                                             ...
                                             onkeyup="value=this.value.replace(/\D+/g,'')"> 个
                    </div>
                </li>
            </ul>
        </div>
            ...
            <ul>
                ...
                <li><span class="labelSpan">最低租赁时间：</span>
                    ...
                    <div class="text"><input name="g_leaseTime" type="text"
                                             ...
                                             onkeyup="value=this.value.replace(/\D+/g,'')"> 月
                    </div>
                </li>
                ...
                <li class="b"><span class="labelSpan">租赁说明：</span>
                    ...
                    <div class="text">
                        <textarea name="g_leaseDescription" cols=""
                                  rows=""><#if (good.leaseDescription)??>${good.leaseDescription}</#if></textarea></div>
                </li>
                <li class="b"><span class="labelSpan">租赁协议：</span>

                    <div class="text"><textarea name="g_leaseAgreement" cols=""
                                                rows=""><#if (good.leaseAgreement)??>${good.leaseAgreement}</#if></textarea>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="item_list clear">
            <ul>
                <li class="b"><span class="labelSpan">详细说明：</span>
                    ...
                    <div class="text"><textarea name="g_description" cols=""
                                                rows=""><#if (good.description)??>${good.description}</#if></textarea>
                    </div>
                </li>
                <li><span class="labelSpan">POS机图片：</span>
                    ...
                    <div class="text" id="photos">
                        <#list 0..2 as i>
                            <form id="fileForm${i}" action="<@spring.url "/pos/uploadImg" />" method="post"
                                  enctype="multipart/form-data">
                                <div class="item_photoBox">
                                    <#if (good.pictures[i])??>
                                        <img src="<@spring.url "/resources/images/zp.jpg" />" class="cover"
                                             value="<@spring.url good.pictures[i].urlPath />"
                                             dbValue="${good.pictures[i].urlPath}">
                                        <a href="javascript:void(0);" class="informImg_a">
                                            <span>重新上传</span><input name="file" type="file" onChange="fileChange(this)"
                                                                    index="${i}"/>
                                        </a>
                                    <#else>
                                        <a href="javascript:void(0);" class="informImg_a">
                                            <span>上传照片</span><input name="file" type="file" onChange="fileChange(this)"
                                                                    index="${i}"/>
                                        </a>
                                    </#if>
                                </div>
    ...
    <div class="btnBottom">
        <button class="blueBtn" onClick="submitData()">
            <#if good??>
                确定
            <#else>创建
            </#if>
...
$("#channel_result_id").hide();
var newDiv = '
<div class="item_relevance_pro" value="'+id+'"><span>'+name+' < /span> <a class="a_btn" onClick="del(this)">删除</
a > < / div > ';
