        ...
        <div class="item_list clear">
            <ul>
                ...
                <li><span class="labelSpan">帐号ID：</span>
                    <div class="text"><input name="account" type="text" value="${customer.username}"></div>
                </li>
                ...
                <li><span class="labelSpan">角色：</span>
                    <div class="text">
                        ...
                        <a class="pay_add_a">+</a>
                        <div class="ia_area">
                            <#list customerRoles as role>
                                <span class='iaa_c' data-id='${role.id}'>${role.roleName}<a class='dele'>删除</a></span>
                            </#list>
                        </div>
                    </div>
                </li>
