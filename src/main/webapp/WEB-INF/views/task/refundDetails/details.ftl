...
<@c.html>
    <div class="breadcrumb">
                    <ul>
                        ...
                        <li><a href="<@spring.url "/task/refund/refundeDetails/${refundDetails.id}" />">详情</a></li>
                    </ul>
                </div>
                    ...
                    <div class="attributes_box">
                        ...
                        <div class="attributes_list_s clear">
                            <ul>
                                ...
                                <li>相关业务：<a href="javascript:void(0)" onClick="goRefundDetails(${refundDetails.returnId},${refundDetails.type})" class="a_btn">${(refundDetails.returnApplyNum)!""}</a></li>
