<tr data-id="${customer.id}">
    ...
    <td>
    <#if Roles.hasRole("USER_PSW_RESET")><a href="<@spring.url "/user/${customer.id}/resetpwd"/>" class="a_btn" target="_blank">重置密码</a></#if>
    <#if Roles.hasRole("USER_EDIT")><a href="<@spring.url "/user/${customer.id}/edit"/>" class="a_btn" target="_blank">编辑</a></#if>
    ...
    <a href="<@spring.url "/user/${customer.id}/info"/>" class="a_btn" target="_blank">查看详情</a>
    </td>
</tr>
