...
<head>
    ...
    <script language="javascript" type="text/javascript" src="<@spring.url "/resources/js/video/anychatevent.js"/>"></script>
    <script language="javascript" type="text/javascript" src="<@spring.url "/resources/js/video/advanceset.js"/>" charset="GB2312"></script>
    <!-- 加载业务逻辑控制脚本  -->
    <script language="javascript" type="text/javascript" src="<@spring.url "/resources/js/video/logicfunc.js"/>" ></script>
    <link href="/resources/video/css/demo.css" rel="stylesheet" type="text/css" />
    <link href="/resources/video/css/advanceset.css" rel="Stylesheet" type="text/css" />
</head>
...
<!--操作等待层 -->
<div id="LOADING_DIV"><img src="<@spring.url "/resources/images/LoadImg.gif"/>" alt="请等待..." style=" height:50px;" /></div>
